...
class CanvDTP {
  ...
  static get BODY_OPEN() {
    return 0x00;
  }

  static get BODY_CLOSED() {
    return 0x01;
  }

  static get BODY_EXPANDING() {
    return 0x02;
  }

  static get BODY_COLLAPSING() {
    return 0x03;
  } //Calendar view.


  static get CAL_CENTURY() {
    return 0x00;
  }

  static get CAL_DECADE() {
    return 0x01;
  }
  ...
  static get CAL_MONTH() {
    return 0x03;
  }

  static get CAL_MINUTE() {
    return 0x04;
  }

  static get CAL_STD_HOUR() {
    return 0x05;
  }

  static get CAL_MIL_HOUR() {
    return 0x06;
  }

  static get CAL_MIN_HOUR() {
    return 0x07;
  ...
  static get SEL_DECADE() {
    return 0x08;
  }

  static get SEL_MINC1() {
    return 0x09;
  }

  static get SEL_MINC10() {
    return 0x0A;
  }

  static get SEL_MDEC1() {
    return 0x0B;
  }

  static get SEL_MDEC10() {
    return 0x0C;
  }

  static get SEL_HINC1() {
    return 0x0D;
  }

  static get SEL_HDEC1() {
    return 0x0E;
  }
  ...
  static get GRID_MONTH() {
    return 0x00;
  }

  static get GRID_GENERAL() {
    return 0x01;
  }

  static get GRID_TIME() {
    return 0x02;
  }

  static get GRID_MINUTE() {
    return 0x03;
  }

  static get GRID_STD_HOUR() {
    return 0x04;
  }

  static get GRID_MIL_HOUR() {
    return 0x05;
  ...
  static get WHITE_BOTH() {
    return 0x00;
  }

  static get WHITE_SPTLT() {
    return 0x01;
  }

  static get WHITE_BLOCK() {
    return 0x02;
  }

  static get WHITE_NONE() {
    return 0x03;
  } //Picker format types.


  static get PICK_BOTH() {
    return 0x00;
  }

  static get PICK_DATE() {
    return 0x01;
  }

  static get PICK_TIME() {
    return 0x02;
  } //Date compare return types.


  static get DATE_EQUAL() {
    return 0x00;
  }

  static get DATE_GREATER() {
    return 0x01;
  }

  static get DATE_LESS() {
    return 0x02;
  }

  static get DATE_1INVALID() {
    return 0x03;
  }

  static get DATE_2INVALID() {
    return 0x04;
  } //Bosy canvas position relative to the textbox.


  static get POS_BOTLEFT() {
    return 0x00;
  }

  static get POS_BOTRIGHT() {
    return 0x01;
  }

  static get POS_TOPLEFT() {
    return 0x02;
  }

  static get POS_TOPRIGHT() {
    return 0x03;
  } ///////////////////////////////////////////////////////////////////////////////////////////////
  //                                        Constructor                                        //
  ///////////////////////////////////////////////////////////////////////////////////////////////
  ...
  constructor(parentDiv, {
    ...
    //Returns selected time string.
    dateTimeJSONCb = null,
    //Returns selected time JSON object.
    openCb = null,
    closeCb = null,
    hourChangeCb = null,
    minuteChangeCb = null,
    ...
    zIndex = 1,
    //Z index of the body canvas.
    dateTimeFormat = null,
    //Enable date and/or time and set the string format.
    pickerType = CanvDTP.PICK_BOTH,
    //Enable date and/or time picker.
    isAnimated = true,
    //Enable/disable open/close animation.
    maxPixelWidth = null,
    //Maximum width in pixels of the body canvas.
    startOfWeek = CanvDTP.SUNDAY,
    //Sets which day the week starts on.
    isMilitaryTime = false,
    //Select time format.
    dayExcludeArray = [],
    //Array of excluded months, days, years in the month view.
    dayWhiteArray = [],
    //Array of whitelist months, days, years in the month view.
    monthSpotlightArray = [],
    //Array of spotlighted months in the year view.
    monthWhiteArray = [],
    //Array of whitelist months, in the year view.
    yearSpotlightArray = [],
    //Array of spotlighted years in the decade view.
    yearWhiteArray = [],
    //Array of whitelist years, in the decade view.
    monthImages = [],
    //Optional images to display in the month view.
    fontStyle = "Arial",
    //The font to use for all the text.
    textMainColorn = "#000000",
    //The primary color for non-hovered items.
    textMainColorh = "#ffffff",
    //The primary color for hovered items.
    textAltColorn = "#888888",
    //The alternate for non-hovered items.
    textAltColorh = "#ff8888",
    //The alternate for hovered items.
    rangeBkColor = "#000000a0",
    //Out of range date colors.
    firstDate = null,
    //Earliest date available to user.
    lastDate = null,
    //Latest date available to user.
    initDate = null,
    //Date to use on first pick when picker opened.
    autoPick = true,
    //Enable automatic date pick when picker opened.
    todaysDate = true,
    //Enable today's date marker on calendar.
    topView = CanvDTP.CAL_CENTURY,
    //Top view is the century view.
    calendarIcon = true,
    //Enable the calendar icon next to the textbox.
    bodyPosition = CanvDTP.POS_BOTLEFT,
    //Position of body canvas with respect to the textbox.
    isCollapsible = true,
    //Allows the body canvas to be minimized.
    ...
    this.contentRight;
    this.contentTop;
    this.contentBottom; //Heights and widths of the various selection boxes.

    this.smallBoxHeight;
    this.smallBoxWidth;
    this.bigBoxHeight;
    this.bigBoxWidth; //Inner dimensions for year, decade and century views.

    this.innerTop;
    this.innerBottom;
    this.innerLeft;
    this.innerRight; //Dimensions for the time view only.
    ...
    this.timeBottom;
    this.timeBoxWidth;
    this.timeBoxHeight; //Clock graphic radius.

    this.clockRadius; //Text centering variables.
    ...
    this.bodyCanvas;
    this.iconCanvas;
    this.infotext; //Set the z index of the body canvas.

    this.zIndex = zIndex; //Contexts of the canvases.

    this.ctxDTP;
    this.ctxIcon; //Current icon colors.

    this.iBorderColor = this.iBorderColorn;
    this.iFillColor = this.iFillColorn;
    this.iCalColor = this.iCalColorn; //Keep track of the body canvas animation state.

    this.bodyCanAnim = CanvDTP.BODY_CLOSED;
    this.bodyAnimTimer;
    this.bodyAnimStep; //Both canvases are squares.  Keep track of their dimensions.

    this.bodyCanWidth = 0;
    this.bodyCanMaxWidth;
    this.iconCanWidth; //Animation variables.

    this.animTime = 25;
    this.animSteps = 10; //Keep track of the x and y mouse position over the body canvas.

    this.bodyX = -1000;
    this.bodyY = -1000; //Mouse Pointer

    this.PointerWidth = .005, this.PointerRad = .01, this.PointerColor = "#000000", //Variables for keeping track of date and time.
    this.isFirstPicked = false;
    this.isLeapYear = false;
    this.pickedDay = 0;
    this.dayType = CanvDTP.DAY_THIS; //Currently selected date and time.
    ...
    this.dayMonthStart = undefined; //Date used for drawing current canvas values.
    ...
    this.tempMinute;
    this.tempHour; //Todays date.

    this.nowYear;
    this.nowMonth;
    this.nowDay; //Keep track of currently picked item and view.
    ...
    this.pickedMonth = 0;
    this.pickedYear = 0;
    this.pickedDecade = 0; //Keep track of wether out or range checks need to be done.

    this.checkBefore = false;
    this.checkAfter = false;
    this.firstHit = false;
    this.lastHit = false; //Array of excluded/highlighted days for the currently selected month.

    this.monthSpecial = new Array(42);
    this.updateMonth = false; //Array of highlighted months for the currently selected year.

    this.yearSpecial = new Array(12);
    this.updateYear = false; //Array of highlighted years for the currently selected decade.

    this.decadeSpecial = new Array(12);
    this.updateDecade = false; //Calendar drawing and hit detection variables.

    this.dayArray = new Array(42);
    this.hitBounds = [];
    this.days = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"], this.days3 = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"];
    ...
    this.shortMonthsArray = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]; //Only create date/time picker if the parent exists.
  ...
  init() {
    ...
    this.infoPoint = document.createElement("span"); //Do not draw calendar icon if the calendar is not collapsible.

    if (!this.isCollapsible) this.calendarIcon = false; //Only create an icon canvas if it is enabled.

    if (this.calendarIcon) this.iconCanvas = document.createElement("canvas"); //Setup initial styling of the info text.
    ...
    this.infoPoint.style.borderColor = this.infoBackColor + " transparent transparent transparent"; //Add an id to the text box.

    this.dtpText.setAttribute("id", this.parentDiv.id + "-tb"); //Get 2D contexts of the canvases.

    this.ctxDTP = this.bodyCanvas.getContext("2d");
    if (this.calendarIcon) this.ctxIcon = this.iconCanvas.getContext("2d"); //Clear anything out of the parent div.

    this.parentDiv.innerHTML = ""; //Add all the components to the div.
    ...
    this.infoParent.appendChild(this.infoPoint); //Add placeholder text to the textbox and make it read only.

    this.dtpText.placeholder = this.calendarIcon ? "Click Icon for Date/Time" : "Click Textbox for Date/Time";
    this.dtpText.readOnly = true; //Setup positioning to ignore any parent padding.
    ...
    this.bodyCanvas.style.zIndex = this.zIndex; //Setup default cursor for icon canvas.

    if (this.calendarIcon) this.iconCanvas.style.cursor = "pointer"; //Add resize and click listeners to the window.

    window.addEventListener("resize", () => this.resize());
    window.addEventListener("click", event => this.windowClick(event)); //Add icon event listeners.
    ...
    this.bodyCanvas.addEventListener("click", () => this.bodyClick()); //Add textbox event listener.

    this.dtpText.addEventListener("click", () => this.textClick()); //Setup picker type.
  ...
  resize() {
    ...
    let padRect = this.paddingDiv.getBoundingClientRect(); //Set the width of the text area - leave room for the icon canvas.
    ...
    this.iconCanWidth = rect.height; //Set the animation step size for the body canvas.

    this.bodyAnimStep = this.bodyCanMaxWidth / this.animSteps; //Maximize the canvas size if it is open.

    if (this.bodyCanAnim === CanvDTP.BODY_OPEN) {
      //Never exceed textbox width.
      this.bodyCanWidth = this.bodyCanMaxWidth; //Don't exceed user set max pixel width.
    ...
    if (!this.isCollapsible) {
      let padHeight;
      this.bodyCanAnim = CanvDTP.BODY_OPEN; //Set the height of the calendar.
      ...
      this.parentDiv.style.height = padHeight + padRect.height + "px"; //Check if date/time has been picked already.
    ...
    let leftPos = rect.width - this.bodyCanWidth; //Place the main date/time picker in the proper location.
  ...
  textClick() {
    ...
    if (this.bodyCanAnim === CanvDTP.BODY_CLOSED || this.bodyCanAnim === CanvDTP.BODY_COLLAPSING) {
      this.bodyCanAnim = this.isAnimated ? CanvDTP.BODY_EXPANDING : CanvDTP.BODY_OPEN; //Check if date/time has been picked already.
  ...
  iconClick() {
    //Set the animation to expanding or collapsing.
    this.bodyCanAnim = this.bodyCanAnim === CanvDTP.BODY_CLOSED || this.bodyCanAnim === CanvDTP.BODY_COLLAPSING ? this.isAnimated ? CanvDTP.BODY_EXPANDING : CanvDTP.BODY_OPEN : this.isAnimated ? CanvDTP.BODY_COLLAPSING : CanvDTP.BODY_CLOSED; //Check if date/time has been picked already.
  ...
  iconDraw() {
    ...
    if (this.iconCanWidth <= 5) return; //---------------- Draw the border ----------------
    ...
    this.ctxIcon.arc(this.iconCanWidth - this.iconCanWidth * this.iBorderRadius - borderPx / 2, this.iconCanWidth * this.iBorderRadius + borderPx / 2, this.iconCanWidth * this.iBorderRadius, -Math.PI / 2, 0);
    this.ctxIcon.arc(this.iconCanWidth - this.iconCanWidth * this.iBorderRadius - borderPx / 2, this.iconCanWidth - this.iconCanWidth * this.iBorderRadius - borderPx / 2, this.iconCanWidth * this.iBorderRadius, 0, Math.PI / 2);
    ...
    this.ctxIcon.fill();
    this.ctxIcon.stroke(); //----------- Draw the calendar graphic -----------
    ...
    let gridHeight = (gridBottom - gridTop) / 4; //Draw the top of the calendar.
    ...
    this.ctxIcon.lineTo(iXPad + 5 * topWidth, iYPad + 2 * iLWidth); //Draw calendar grid.
  ...
  firstPick() {
    ...
    this.milHour = this.hour; //Convert military time to AM/PM.
    ...
    if (this.firstDate && isFirstValid && isOrderValid) this.checkBefore = true; //Determine if a last date check needs to be done.

    if (this.lastDate && isLastValid && isOrderValid) this.checkAfter = true; //If the initial pick date is before first date, set it to first date. 

    if (this.checkBefore && this.compareDates({
      month: this.month,
      day: this.day,
      year: this.year
    }, this.firstDate) === CanvDTP.DATE_LESS) {
    ...
    if (this.checkAfter && this.compareDates({
      month: this.month,
      day: this.day,
      year: this.year
    }, this.lastDate) === CanvDTP.DATE_GREATER) {
    ...
    this.tempCentury = parseInt(this.year / 100) * 100; //Indicate the month exclusions need to be calculated.

    this.updateMonth = true;
    this.updateYear = true;
    this.updateDecade = true;
    this.updateDayArray();
    this.monthExclude(); //Try to find the currently selected date in the current month being displayed.

    for (let i = 0; i < this.dayArray.length; i++) {
      if (this.year === this.dayArray[i].year && this.month === this.dayArray[i].month && this.day === this.dayArray[i].day) {
        todaysIndex = i;
      }
    } //Check if current date is blocked.


    if (todaysIndex >= 0 && this.monthSpecial[todaysIndex].excluded) todayExcluded = true; //Delete the current date if no auto pick or date is blocked.
  ...
  updateDayArray() {
    ...
    let dayMonthStart = startDate.getDay(); //Update the array with the current month days.
    ...
    if (dayMonthStart > 0) {
      i = dayMonthStart - 1; //Special case for March on leap years.
  ...
  formatDateTime(formatString) {
    ...
    let dtString = "";
    let yearInt = parseInt(this.year); //Process whole format string.

    while (currentIndex < lastIndex) {
      let currentToken = formatString[currentIndex];
      let firstChar = formatString[currentIndex++]; //Get string of same characters.
      ...
      tokenLength = currentToken.length; //Figure out what the token is before formatting it.
      ...
      switch (currentToken[0]) {
        case 'M':
          ...
          if (this.pickerType === CanvDTP.PICK_TIME) {
            ...
            dtString += this.month; //Add ordinal, if neccessary.
        ...
        case 'D':
          ...
          if (this.pickerType === CanvDTP.PICK_TIME) {
            ...
            dtString += this.day; //Add ordinal, if neccessary.
            ...
            dtString += this.dayOfYear; //Add ordinal, if neccessary.
            ...
            if (this.dayOfYear < 10) dtString += "00";else if (this.dayOfYear < 100) dtString += "0";
        ...
        case 'W':
          if (this.pickerType === CanvDTP.PICK_TIME) {
            ...
            dtString += this.weekOfYear; //Add ordinal, if neccessary.
  ...
  textBoxDateTime() {
    if (!this.isFirstPicked) return; //Calculate the day of the week.
    ...
    this.weekOfYearCalc();
    let dateTimeString;
    let formatString; //Check user defined format.
    ...
    this.dtpText.value = dateTimeString; //Check if any callbacks have been set and return the data.
  ...
  weekOfYearCalc() {
    ...
    let dayMonthStart = startDate.getDay(); //Calculate how many days into the first week the year starts at.
  ...
  doCommonHitBounds(doInner, doBanner, selectType) {
    let x1, x2, y1, y2; //Hit boundaries for year, decade and century.
  ...
  decadeSpotlight(yearBase) {
    ...
    for (let i = 0; i < 12; i++) {
      ...
      let hit = false; //Loop through the whitelist array looking for years that align with the current decade view.

      for (let j = 0; j < this.yearWhiteArray.length; j++) {
        hit = this.decadeSpotlightYear(this.decadeSpecial[i], this.yearWhiteArray[j]); //Update the element in the yearSpecial array.
    ...
    for (let i = 0; i < this.decadeSpecial.length; i++) {
      let hit = false; //Loop through the spotlights array looking for years that align with the current decade view.

      for (let j = 0; j < this.yearSpotlightArray.length; j++) {
        hit = this.decadeSpotlightYear(this.decadeSpecial[i], this.yearSpotlightArray[j]); //Update the element in the yearSpecial array.
        ...
        if (hit) {
          ...
          this.decadeSpecial[i].color = this.yearSpotlightArray[j].color; //Append any info for this month.
  ...
  yearSpotlight() {
    ...
    for (let i = 0; i < 12; i++) {
      ...
      let hit = false; //Loop through the whitelist array looking for months that align with the current year view.

      for (let j = 0; j < this.monthWhiteArray.length; j++) {
        hit = this.yearSpotlightMonth({
          month: CanvDTP.JANUARY + i,
          year: this.tempYear
        }, this.monthWhiteArray[j]); //Update the element in the yearSpecial array.
    ...
    for (let i = 0; i < this.yearSpecial.length; i++) {
      let hit = false; //Loop through the spotlights array looking for months that align with the current year view.

      for (let j = 0; j < this.monthSpotlightArray.length; j++) {
        hit = this.yearSpotlightMonth(this.yearSpecial[i], this.monthSpotlightArray[j]); //Update the element in the yearSpecial array.

        if (hit) {
          //Exit if this element is whitelisted.
          if (this.yearSpecial[i].whitelist === CanvDTP.WHITE_SPTLT) continue;
          this.yearSpecial[i].isSpecial = true;
          this.yearSpecial[i].color = this.monthSpotlightArray[j].color; //Append any info for this month.
  ...
  monthExclude() {
    ...
    for (let i = 0; i < this.dayArray.length; i++) {
      ...
      let hit = false; //Loop through the exclusion array looking for days that align with the current month view.

      for (let j = 0; j < this.dayWhiteArray.length; j++) {
        hit = this.monthExcludeDay(this.dayArray[i], this.dayWhiteArray[j]); //Update the element in the monthSpecial array.
    ...
    for (let i = 0; i < this.dayArray.length; i++) {
      ...
      for (let j = 0; j < this.dayExcludeArray.length; j++) {
        hit = this.monthExcludeDay(this.dayArray[i], this.dayExcludeArray[j]); //Update the element in the monthSpecial array.

        if (hit) {
          //Exit if this element is whitelisted.
          if (this.monthSpecial[i].whitelist === CanvDTP.WHITE_BOTH) continue;else if (this.monthSpecial[i].whitelist === CanvDTP.WHITE_BLOCK && this.dayExcludeArray[j].excluded) continue;else if (this.monthSpecial[i].whitelist === CanvDTP.WHITE_SPTLT && !this.dayExcludeArray[j].excluded) continue;
          this.monthSpecial[i].isSpecial = true; //Only update exclusion status and color if this element is not already excluded.
  ...
  pointerDraw() {
    ...
    let pointerWidth = this.bodyCanWidth * this.PointerWidth; //Draw a mouse indicator. For debug purposes.
  ...
  drawPrevious(color) {
    ...
    this.ctxDTP.lineWidth = 1;
    this.ctxDTP.moveTo(this.contentLeft + this.prevNextXPad * this.smallBoxWidth, this.contentTop + .5 * this.smallBoxHeight);
    this.ctxDTP.lineTo(this.contentLeft + this.smallBoxWidth - this.prevNextXPad * this.smallBoxWidth, this.contentTop + this.prevNextYPad * this.smallBoxHeight);
    this.ctxDTP.lineTo(this.contentLeft + this.smallBoxWidth - this.prevNextXPad * this.smallBoxWidth, this.contentTop + this.smallBoxHeight - this.prevNextYPad * this.smallBoxHeight);
    this.ctxDTP.fill();
    this.ctxDTP.stroke();
  ...
  drawNext(color) {
    ...
    this.ctxDTP.fillStyle = color;
    this.ctxDTP.lineWidth = 1;
    this.ctxDTP.moveTo(this.contentRight - this.prevNextXPad * this.smallBoxWidth, this.contentTop + .5 * this.smallBoxHeight);
    this.ctxDTP.lineTo(this.contentRight - this.smallBoxWidth + this.prevNextXPad * this.smallBoxWidth, this.contentTop + this.prevNextYPad * this.smallBoxHeight);
    this.ctxDTP.lineTo(this.contentRight - this.smallBoxWidth + this.prevNextXPad * this.smallBoxWidth, this.contentTop + this.smallBoxHeight - this.prevNextYPad * this.smallBoxHeight);
    this.ctxDTP.fill();
    this.ctxDTP.stroke();
  ...
  drawClock(color) {
    ...
    this.ctxDTP.arc(this.contentLeft + .5 * this.contentWidth, this.contentTop + 8 * this.smallBoxHeight + .5 * this.smallBoxHeight, this.clockRadius, 0, 2 * Math.PI);
    this.ctxDTP.moveTo(this.contentLeft + .5 * this.contentWidth - .60 * this.clockRadius, this.contentTop + 8 * this.smallBoxHeight + .5 * this.smallBoxHeight);
    this.ctxDTP.lineTo(this.contentLeft + .5 * this.contentWidth, this.contentTop + 8 * this.smallBoxHeight + .5 * this.smallBoxHeight);
    this.ctxDTP.lineTo(this.contentLeft + .5 * this.contentWidth, this.contentTop + 8 * this.smallBoxHeight + .5 * this.smallBoxHeight - .85 * this.clockRadius);
    this.ctxDTP.stroke();
  }
  ...
  calDraw(color) {
    ...
    this.ctxDTP.lineTo(calLeft + iXPad + 5 * topWidth, calTop + iYPad + 2 * iLWidth); //Draw calendar grid.
  ...
  highlightHovItem(i) {
    ...
    this.pickedType = this.hitBounds[i].type; //Exit if first date is hit.

    if (this.pickedType === CanvDTP.SEL_PREVIOUS && this.firstHit) return; //Exit if last date is hit.

    if (this.pickedType === CanvDTP.SEL_NEXT && this.lastHit) return; //Determine the top view that can be shown.

    if (this.pickedType === CanvDTP.SEL_VIEW && this.calView <= this.topView) return; //Indicate something can be picked.

    this.isPicked = true; //Get additional info for days of month.
    ...
    let selectRadius = (this.hitBounds[i].y2 - this.hitBounds[i].y1) * this.selectRadius; //Draw the border and fill the space.
  ...
  bodyDimCalc() {
    ...
    this.clockRadius = this.smallBoxHeight * .5 - this.clockPad * this.smallBoxHeight; //Time view calculations.
  ...
  bodyCoords(mouseEvent) {
    ...
    let obj_left = 0;
    let obj_top = 0; //Get the offset of the body canvas and all its parents accumulated.
  ...
  bodyAnimate() {
    switch (this.bodyCanAnim) {
      ...
      case CanvDTP.BODY_EXPANDING:
        this.bodyCanWidth += this.bodyAnimStep; //Never exceed textbox width.
  ...
  bodyDraw() {
    //Exit if the canvas does not meet minimum size dimensions.
    if (this.bodyCanWidth <= 5) return; //Reset the canvas dimensions. For some reason the canvas performance degrades
    //over time. This prevents that from happening. A bug in the Canvas API?

    this.bodyCanvas.width = this.bodyCanWidth;
    this.bodyCanvas.height = this.bodyCanWidth; //Calculate the body canvas item dimensions.

    this.bodyDimCalc();
    this.updateDayArray();
    this.ctxDTP.clearRect(0, 0, this.bodyCanWidth, this.bodyCanWidth); //Calculate the padding pixels and line width.

    var borderPx = this.bodyCanWidth * this.bBorderWeight;
    var borderRad = this.bodyCanWidth * this.bBorderRadius;
    var borderWidth = Math.ceil(this.bodyCanWidth * this.bBorderWeight); //Draw the border and background fill.

    this.ctxDTP.beginPath();
    this.ctxDTP.lineWidth = borderWidth;
    this.ctxDTP.strokeStyle = this.bBorderColor; //Draw a clipping rectangle.
    ...
    this.ctxDTP.fill(); //Try to add a background image to the month view.
    ...
    if (this.calView === CanvDTP.CAL_MONTH && this.dateTime === CanvDTP.CAL_DATE) {
      try {
        ...
        this.ctxDTP.globalAlpha = 1;
      }
    }

    this.ctxDTP.stroke(); //If in debug mode, draw a pointer on the body canvas.

    if (this.debug) this.pointerDraw(); //Determine what to draw in the body canvas.
  ...
  drawMonth() {
    ...
    if (this.debug) this.gridDraw(CanvDTP.GRID_MONTH); //Update the month exclusions, if necessary.
    ...
    let index;
    this.firstHit = false;
    this.lastHit = false; //Hit boundaries for the days.
    ...
    this.doCommonHitBounds(false, true, null); //Draw the day numbers.
    ...
    for (let i = 0; i < CanvDTP.NUM_DAYS; i++) {
      ...
      if (isSelected) this.fillCurrent(i); //Highlight today's date.
      ...
      if (isToday && this.todaysDate) {
        ...
        let triLength = h * this.nowWeight; //Draw the border and fill the space.   
      ...
      this.dayArray[i].type === CanvDTP.DAY_THIS ? this.ctxDTP.fillStyle = this.textMainColorn : this.ctxDTP.fillStyle = this.textAltColorn; //Get the text metrics.
      ...
      this.ctxDTP.fillText(this.text, this.hitBounds[i].x1 + this.textLeft, this.hitBounds[i].y2 + this.textBottom - this.smallBoxHeight + verOffset);
    }

    this.ctxDTP.stroke(); //Draw the days of the week header.
    ...
    for (let i = 0; i < 7; i++) {
      ...
      if (index >= this.days.length) index = 0; //Get the text metrics.
      ...
      this.textBottom = Math.abs(this.smallBoxHeight - this.textHeight) / 2;
      this.ctxDTP.textBaseline = "top";
      this.ctxDTP.fillText(this.days[index++], this.contentLeft + i * this.smallBoxWidth + this.textLeft, this.contentTop + this.smallBoxHeight + this.textBottom);
    }

    this.ctxDTP.stroke(); //Draw the date and year.

    this.ctxDTP.beginPath();
    this.ctxDTP.fillStyle = this.textMainColorn;
    this.ctxDTP.font = this.smallBoxHeight * this.bannerScale + "px " + this.fontStyle; //Get the text metrics.
    ...
    this.textBottom = Math.abs(this.smallBoxHeight - this.textHeight) / 2;
    this.ctxDTP.textBaseline = "top";
    this.ctxDTP.fillText(this.text, this.contentLeft + this.smallBoxWidth + this.textLeft, this.contentTop + this.textBottom);
    this.ctxDTP.stroke();
    ...
    this.isPicked = false; //Indicate if any info text was found.

    let infoFound = false;

    for (let i = 0; i < this.hitBounds.length; i++) {
      if (this.bodyX >= this.hitBounds[i].x1 && this.bodyX <= this.hitBounds[i].x2 && this.bodyY >= this.hitBounds[i].y1 && this.bodyY <= this.hitBounds[i].y2) {
        //Exit if date picker only.
        if (this.pickerType === CanvDTP.PICK_DATE && this.hitBounds[i].type === CanvDTP.SEL_TIME) continue; //Do special stuff for special days.
        ...
        if (this.hitBounds[i].hasOwnProperty("index") && this.monthSpecial[this.hitBounds[i].index].isSpecial) {
          if (this.monthSpecial[this.hitBounds[i].index].info.length) {
            ...
            this.infoPoint.style.visibility = "visible"; //Print all the info text with comma separations.
  ...
  drawYear() {
    ...
    let inRange = true;
    let first;
    let last; //Draw a grid on the canvas. For debugging purposes.

    if (this.debug) this.gridDraw(CanvDTP.GRID_GENERAL); //Update the year spotlights, if necessary.
    ...
    this.hitBounds = [];
    this.doCommonHitBounds(true, true, CanvDTP.SEL_MONTH); //Get first date and set day of month to is min value.

    if (this.checkBefore) {
      first = _objectSpread({}, this.firstDate);
      first.day = 1;
    } //Get last date and set day of month to its max value.


    if (this.checkAfter) {
      last = _objectSpread({}, this.lastDate);
    ...
    for (let i = 0; i < 12; i++) {
      ...
      let y2 = this.hitBounds[i].y2; //Disable previous button if necessary.

      if (this.checkBefore && this.compareDates({
        month: i + 1,
        day: first.day,
        year: this.tempYear
      }, first) === CanvDTP.DATE_EQUAL) {
        this.firstHit = true;
    ...
    for (let i = 0; i < 12; i++) {
      ...
      this.ctxDTP.fillStyle = this.textMainColorn; //Get the text metrics.
      ...
      this.ctxDTP.textBaseline = "top";
      this.ctxDTP.fillText(this.shortMonthsArray[i], this.hitBounds[i].x1 + this.textLeft, this.hitBounds[i].y2 + this.textBottom - this.bigBoxHeight);
      this.ctxDTP.stroke();
    } //Draw the year
    ...
    for (let i = 0; i < this.hitBounds.length; i++) {
      if (this.bodyX >= this.hitBounds[i].x1 && this.bodyX <= this.hitBounds[i].x2 && this.bodyY >= this.hitBounds[i].y1 && this.bodyY <= this.hitBounds[i].y2) {
        //Exit if date picker only.
        if (this.pickerType === CanvDTP.PICK_DATE && this.hitBounds[i].type === CanvDTP.SEL_TIME) continue; //Do special stuff for special months.
        ...
        this.pickedMonth = i + 1; //Draw the highlighted text.

        switch (this.hitBounds[i].type) {
          case CanvDTP.SEL_MONTH:
            this.ctxDTP.beginPath();
            this.ctxDTP.font = this.bigBoxHeight * this.monthScale + "px " + this.fontStyle;
            this.ctxDTP.fillStyle = this.textMainColorh; //Get the text metrics.
  ...
  drawDecade() {
    ...
    if (this.debug) this.gridDraw(CanvDTP.GRID_GENERAL); //Update the decade spotlights, if necessary.
    ...
    this.hitBounds = [];
    this.doCommonHitBounds(true, true, CanvDTP.SEL_YEAR); //Get first date and set it to first day of the year.
    ...
    for (let i = 0; i < 12; i++) {
      ...
      if (this.checkBefore && this.compareDates({
        month: first.month,
        day: first.day,
        year: this.decadeSpecial[i].year
      }, first) === CanvDTP.DATE_EQUAL) {
        this.firstHit = true;
    ...
    for (let i = 0; i < 12; i++) {
      ...
      this.ctxDTP.fillStyle = !i || i === 11 ? this.textAltColorn : this.ctxDTP.fillStyle = this.textMainColorn; //Get the text metrics.
      ...
      this.textBottom = Math.abs(this.bigBoxHeight - this.textHeight) / 2;
      this.ctxDTP.textBaseline = "top";
      this.ctxDTP.fillText(this.text, this.hitBounds[i].x1 + this.textLeft, this.hitBounds[i].y2 + this.textBottom - this.bigBoxHeight);
      this.ctxDTP.stroke();
    } //Draw the decade.
    ...
    for (let i = 0; i < this.hitBounds.length; i++) {
      if (this.bodyX >= this.hitBounds[i].x1 && this.bodyX <= this.hitBounds[i].x2 && this.bodyY >= this.hitBounds[i].y1 && this.bodyY <= this.hitBounds[i].y2) {
        //Exit if date picker only.
        if (this.pickerType === CanvDTP.PICK_DATE && this.hitBounds[i].type === CanvDTP.SEL_TIME) continue; //Do special stuff for special years.
        ...
        this.pickedYear = yearBase + i; //Draw the highlighted text.

        switch (this.hitBounds[i].type) {
          case CanvDTP.SEL_YEAR:
            this.ctxDTP.beginPath();
            this.ctxDTP.font = this.bigBoxHeight * this.yearScale + "px " + this.fontStyle;
            this.ctxDTP.fillStyle = !i || i === 11 ? this.textAltColorh : this.ctxDTP.fillStyle = this.textMainColorh; //Get the text metrics.
  ...
  drawCentury() {
    ...
    if (this.debug) this.gridDraw(CanvDTP.GRID_GENERAL); //Do hit bounds for previous, next, time and the banner.

    this.hitBounds = [];
    this.doCommonHitBounds(true, false, CanvDTP.SEL_DECADE); //Create an array of potentially excluded decades.
    ...
    for (let i = 0; i < 12; i++) {
      ...
      this.textBottom = Math.abs(this.bigBoxHeight - this.textHeight) / 2;
      this.ctxDTP.textBaseline = "top";
      this.ctxDTP.fillText(this.text + "-", this.hitBounds[i].x1 + this.textLeft, this.hitBounds[i].y2 + this.textBottom - 1.20 * this.bigBoxHeight); //Get the text metrics.
      ...
      this.textBottom = Math.abs(this.bigBoxHeight - this.textHeight) / 2;
      this.ctxDTP.textBaseline = "top";
      this.ctxDTP.fillText(this.text, this.hitBounds[i].x1 + this.textLeft, this.hitBounds[i].y2 + this.textBottom - .80 * this.bigBoxHeight);
      this.ctxDTP.stroke();
    } //Draw the century.
    ...
    for (let i = 0; i < this.hitBounds.length; i++) {
      if (this.bodyX >= this.hitBounds[i].x1 && this.bodyX <= this.hitBounds[i].x2 && this.bodyY >= this.hitBounds[i].y1 && this.bodyY <= this.hitBounds[i].y2) {
        //Exit if date picker only.
        if (this.pickerType === CanvDTP.PICK_DATE && this.hitBounds[i].type === CanvDTP.SEL_TIME) continue; //If the decade is excluded, stop here to prevent highlighting.

        if (i < 12 && decadeExclude[i].excluded) continue;
        this.highlightHovItem(i); //Highlight the hovered item.
        //Get additional info for days of month.

        this.pickedDecade = centuryBase + i * 10 - 9; //Draw the highlighted text.
  ...
  drawTime() {
    //Draw a grid on the canvas. For debugging purposes.
    if (this.debug) this.gridDraw(CanvDTP.GRID_TIME); //Calculate the hit boundaries.

    let x1, x2, y1, y2;
    this.hitBounds = []; //Calendar hit boundaries.
    ...
    this.ctxDTP.fillStyle = this.textMainColorn;
    this.ctxDTP.textBaseline = "top"; //Get the text metrics.
    ...
    (this.text, this.contentLeft + this.textLeft, this.contentTop + this.timeBoxHeight + this.textBottom); //Get the text metrics.
    ...
    (this.text, this.contentLeft + 0.75 * this.timeBoxWidth + this.textLeft, this.contentTop + this.timeBoxHeight + this.textBottom); //Get the text metrics.
    ...
    (this.text, this.contentLeft + 1.5 * this.timeBoxWidth + this.textLeft, this.contentTop + this.timeBoxHeight + this.textBottom); //Draw the hour inc1 icon.

    this.incDraw(this.hitBounds[1].x1, this.hitBounds[1].x2, this.hitBounds[1].y1, this.hitBounds[1].y2, this.textMainColorn, CanvDTP.INC_1); //Draw the minute inc1 icon.

    this.incDraw(this.hitBounds[3].x1, this.hitBounds[3].x2, this.hitBounds[3].y1, this.hitBounds[3].y2, this.textMainColorn, CanvDTP.INC_1); //Draw the minute inc10 icon.

    this.incDraw(this.hitBounds[4].x1, this.hitBounds[4].x2, this.hitBounds[4].y1, this.hitBounds[4].y2, this.textMainColorn, CanvDTP.INC_10); //Draw the hour dec1 icon.

    this.incDraw(this.hitBounds[2].x1, this.hitBounds[2].x2, this.hitBounds[2].y1, this.hitBounds[2].y2, this.textMainColorn, CanvDTP.DEC_1); //Draw the minute dec1 icon.

    this.incDraw(this.hitBounds[5].x1, this.hitBounds[5].x2, this.hitBounds[5].y1, this.hitBounds[5].y2, this.textMainColorn, CanvDTP.DEC_1); //Draw the minute dec10 icon.

    this.incDraw(this.hitBounds[6].x1, this.hitBounds[6].x2, this.hitBounds[6].y1, this.hitBounds[6].y2, this.textMainColorn, CanvDTP.DEC_10);
    this.ctxDTP.stroke(); //Draw AM/PM/MT.
    ...
    this.textLeft = Math.abs(this.timeBoxWidth - this.textWidth) / 2;
    this.textBottom = Math.abs(this.timeBoxHeight - this.textHeight) / 2;
    this.ctxDTP.fillText(this.text, this.contentLeft + 2.5 * this.timeBoxWidth + this.textLeft, this.contentTop + this.timeBoxHeight + this.textBottom);
    this.ctxDTP.stroke(); //Highlight the section being touched by the mouse cursor.
      ...
      if (this.bodyX >= this.hitBounds[i].x1 && this.bodyX <= this.hitBounds[i].x2 && this.bodyY >= this.hitBounds[i].y1 && this.bodyY <= this.hitBounds[i].y2) {
        ...
        switch (this.hitBounds[i].type) {
          ...
          case CanvDTP.SEL_MINC1:
            this.incDraw(this.hitBounds[i].x1, this.hitBounds[i].x2, this.hitBounds[i].y1, this.hitBounds[i].y2, this.textMainColorh, CanvDTP.INC_1);
            break;

          case CanvDTP.SEL_MINC10:
            this.incDraw(this.hitBounds[i].x1, this.hitBounds[i].x2, this.hitBounds[i].y1, this.hitBounds[i].y2, this.textMainColorh, CanvDTP.INC_10);
            break;

          case CanvDTP.SEL_HDEC1:
          case CanvDTP.SEL_MDEC1:
            this.incDraw(this.hitBounds[i].x1, this.hitBounds[i].x2, this.hitBounds[i].y1, this.hitBounds[i].y2, this.textMainColorh, CanvDTP.DEC_1);
            break;

          case CanvDTP.SEL_MDEC10:
            this.incDraw(this.hitBounds[i].x1, this.hitBounds[i].x2, this.hitBounds[i].y1, this.hitBounds[i].y2, this.textMainColorh, CanvDTP.DEC_10);
            break;
          ...
          case CanvDTP.SEL_MINUTE:
            ...
            this.textBottom = Math.abs(this.timeBoxHeight - this.textHeight) / 2;
            this.ctxDTP.fillText //Draw the minutes.
            (this.text, this.contentLeft + 1.5 * this.timeBoxWidth + this.textLeft, this.contentTop + this.timeBoxHeight + this.textBottom);
            break;
          ...
          case CanvDTP.SEL_HOUR:
            ...
            this.textBottom = Math.abs(this.timeBoxHeight - this.textHeight) / 2;
            this.ctxDTP.fillText //Draw the hours.
            (this.text, this.contentLeft + this.textLeft, this.contentTop + this.timeBoxHeight + this.textBottom);
            this.ctxDTP.stroke();
            break;
        }
      }
  ...
  drawMinute() {
    //Draw a grid on the canvas. For debugging purposes.
    if (this.debug) this.gridDraw(CanvDTP.GRID_MINUTE); //Create an array of hit boundaries for the various buttons.
    //Each element has 4 points representing the upper left and lower right corners.

    this.hitBounds = [];
    let x1, x2, y1, y2; //Hit boundaries for the minutes.
    ...
    for (let i = 0; i < this.hitBounds.length; i++) {
      ...
      this.ctxDTP.textBaseline = "top";
      this.ctxDTP.fillText(this.text, this.hitBounds[i].x1 + this.textLeft, this.hitBounds[i].y2 + this.textBottom - (this.hitBounds[i].y2 - this.hitBounds[i].y1));
      this.ctxDTP.stroke();
    } //Highlight the section being touched by the mouse cursor.
    ...
    for (let i = 0; i < this.hitBounds.length; i++) {
      if (this.bodyX >= this.hitBounds[i].x1 && this.bodyX <= this.hitBounds[i].x2 && this.bodyY >= this.hitBounds[i].y1 && this.bodyY <= this.hitBounds[i].y2) {
        ...
        this.tempMinute = i; //Highlight the number.
  ...
  drawStdHour() {
    //Draw a grid on the canvas. For debugging purposes.
    if (this.debug) this.gridDraw(CanvDTP.GRID_STD_HOUR); //Create an array of hit boundaries for the various buttons.
    //Each element has 4 points representing the upper left and lower right corners.

    this.hitBounds = [];
    let x1, x2, y1, y2; //Hit boundaries for the hours.
    ...
    for (let i = 0; i < this.hitBounds.length; i++) {
      if (this.bodyX >= this.hitBounds[i].x1 && this.bodyX <= this.hitBounds[i].x2 && this.bodyY >= this.hitBounds[i].y1 && this.bodyY <= this.hitBounds[i].y2) {
        ...
        this.tempHour = i + 1; //Highlight the number.
  ...
  drawMilHour() {
    //Draw a grid on the canvas. For debugging purposes.
    if (this.debug) this.gridDraw(CanvDTP.GRID_MIL_HOUR); //Create an array of hit boundaries for the various buttons.
    //Each element has 4 points representing the upper left and lower right corners.
      ...
      if (this.dateTime === CanvDTP.CAL_TIME) {
        ...
        switch (this.calView) {
          case CanvDTP.CAL_MONTH:
            switch (this.pickedType) {
              case CanvDTP.SEL_DAY:
                this.isFirstPicked = true; //Adjust the date if a day before the month is chosen.
  ...
  static getEaster(year) {
    ...
    tA = temp + 21;
    if (temp === 29) tA--;
    if (temp === 28 && Remain19 > 10) tA--; //find the next Sunday
  ...
  static getColumbus(year) {
    ...
    let d = 14 - dayOfWeek;
    return {
      month: CanvDTP.OCTOBER,
      day: d
    };
  } //Returns the date of independence day.


  static get getIndependence() {
    return {
      month: CanvDTP.JULY,
      day: 4
    };
  ...
  static get getChristmas() {
    return {
      month: CanvDTP.DECEMBER,
      day: 25
    };
  }

  //Returns the date of new year's day.
  static get getNewYears() {
    return {
      month: CanvDTP.JANUARY,
      day: 1
    };
  ...
  setDayVertOffset(params) {
    this.dayVertOffset = params;
  }

  getDayVertOffset() {
    return this.dayVertOffset;
  }
  ...
  setDateRanges(params) {
    let first = _objectSpread({}, params.firstDate);

    let last = _objectSpread({}, params.lastDate);
    ...
    this.firstDate = _objectSpread({}, params.firstDate);
    this.lastDate = _objectSpread({}, params.lastDate); //Make sure the view stays within a valid range.
  ...
  getDateRanges() {
    ...
    return {
      firstDate: _objectSpread({}, first),
      lastDate: _objectSpread({}, last)
    };
  }
  ...
  setIsAnimated(params) {
    this.isAnimated = params;
  }
